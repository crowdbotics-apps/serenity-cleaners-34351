...
## Project Structure
    ...
    ├── serenity_cleaners_34351  # Django project configurations
...
1. Clone this repo and `cd serenity_cleaners_34351`
...
2. Clone this repo and `cd serenity_cleaners_34351`
